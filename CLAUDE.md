...
- `web/` : ouvrir `index.html`, `404.html`, `confidentialite.html`, `conditions.html` ; vérifier les listes B, C, D ; aucun débordement horizontal à 400 px ; aucune erreur console ; les deux lumières (Papier, Encre).
