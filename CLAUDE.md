...
- App iPhone : encre de minuit `#0B1A28`, papier `#F3EDE0`, or en **filet** `#E0C378` / `#C4A35A`, vocabulaire du cahier (Découper, Feuille, Cabinet, Édition). Voir `docs/DESIGN.md`. Les icônes iOS (`AppIcon-1024.png`, RGB opaque) et Android (`mipmap-*/ic_launcher*.png`, carrée et ronde) sont générées depuis `web/favicon.svg` ; les regénérer ensemble si le monogramme change.
